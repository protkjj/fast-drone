...
def _factory_class(variant):
    ...
    class DiagnosisFactory(ArenaFactory):
        ...
        def _build_m17(self, window, v0, z0):
            ...
            proxy = SolverProxy(ctrl.nmpc.solver, ctrl.nmpc)
...
def main(argv=None):
    ...
    variants = {name: json.loads((OUT/f'{name}.json').read_text(encoding='utf-8')) for name in VARIANTS}
