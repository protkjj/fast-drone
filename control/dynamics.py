...
def compute_allocation_matrix(params):
    ...
    for i in range(nr):
        ...
        # 축마다 순서가 달라지면 쓰는 쪽이 조용히 어긋난다 — 실제로 그렇게
        # 제어기가 무너졌다. 반토크는 스핀축(추력축) 둘레에 걸린다.
        if axis == 'x':
