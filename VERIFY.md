...
| 모드 | 실측 시간(Apple M4, 단일 스레드, 2026-09-26 오후 새 참조) | 최대 메모리 | 결과 |
|---|---|---|---|
| `--quick` | 2.0분(공정성 테스트 75초 + 재실행 2건 41초) | 1.16 GiB | ALL PASS, 재실행 비트 일치 |
| 전체 | 10.9분(공정성 테스트 370초 + 재실행 6건 281초 — M17 측풍은 이제 12 s 완주라 182초) | 2.81 GiB | ALL PASS, 재실행 6건 비트 일치 |
