...
현재 90 mm 동체 설정에서 V_MAX까지 계산한다. 실제로 수렴하고 국소 안정성이
확인된 행만 표에 넣는다. 표 범위 밖의 게인 유지나 누락된 점의 보간은 별도
검증이 필요하다. 표의 끝을 기체의 물리적 최고속도로 해석하면 안 된다.
"""
import json
import pathlib
import sys
...
V_STEP = 2.5
V_MAX = 85.0      # 현재 생성 범위. 물리적 최고속도를 뜻하지 않는다.
