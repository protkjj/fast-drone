...
복원 당시에는 ‘속도 300’의 단위가 불확실해 60 m/s·목표 고도 200 m로 복원했다.
2026-09-17 사용자가 **300 km/h**라고 확인해 기본 목표와 기본 예제를
83.3 m/s(299.88 km/h, 화면 반올림 300 km/h)·200 m로 바꿨다. 속도 조작 간격은
0.1 m/s다. 실제 속도/상태, 기준 명령 램프, 제어기 수식과 화면 배치는 바꾸지 않았다.
