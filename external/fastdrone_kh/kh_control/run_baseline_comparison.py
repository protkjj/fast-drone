...
python -m control.run_baseline_comparison --stage lqr|pilot|short|all
"""
import argparse
...
from kh_control.baseline_v2 import baseline_params, PARAMETER_SHA256, parameter_hash
from kh_control.trim import find_trim
from kh_control.controller import LQRController, ScheduledLQR, INDIController
from kh_control.hybrid_comparison import ProperHybrid, NaiveHybrid
from kh_control.comparison_nmpc import ComparisonNMPC
from kh_control.dynamics import AxialDronePlant
from kh_control.geometry import rotor_thrusts
from kh_control.propeller_curve import domain_status
from kh_control.serialization import jsonable, lqr_weights
from kh_control.mission_sim import MissionProfile
