...
import casadi as ca
import numpy as np
from kh_control.geometry import thrust_axis, hover_quaternion
from kh_control.propeller_curve import uses_curve, symbolic_force_torque
...
def _body_aerodynamics(v_body, omega, p):
    ...
    if p.get('aero_model') == 'distributed_light_v1':
        from kh_control.light_aero import light_aerodynamics
